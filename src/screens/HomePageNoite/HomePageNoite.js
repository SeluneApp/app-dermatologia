...
const HomePageNoite = ({ navigation }) => {
  ...
  // Esta é a nova função que irá navegar para a tela de conteúdo
        ...
        <View style={styles.overlayContent}>
          ...
          <View style={styles.dailyTipsSection}>
            <View style={styles.dailyTipsHeader}>
              ...
              {/* MODIFICAÇÃO: A seta agora é um TouchableOpacity que navega para 'Conteudo' */}
...
const styles = StyleSheet.create({
  ...
  arrowIconContainer: { // Novo estilo para tornar a área de toque maior
    marginLeft: 'auto',
    padding: 10,
  },
  arrowIcon: {
