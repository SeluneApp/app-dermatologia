...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Dimensions, TextInput, Alert, ActivityIndicator } from 'react-native';
...
// Função auxiliar para obter a data atual formatada (Ex: '2025-09-28')
...
const DailyEntryScreen = ({ navigation, route }) => {
    ...
    const [selectedTexture, setSelectedTexture] = useState(null); // Adicionado para a textura
    ...
    const handleFeelingSelect = (feeling) => {
        setSelectedFeeling((prev) =>
            ...
            prev.filter((item) => item !== feeling) : [...prev, feeling]
        );
    };
        ...
        <View style={styles.mainWrapper}>
            <LinearGradient colors={['#1F0E4D', '#3B176B']} style={styles.backgroundImage}>
                ...
                >
                    ...
                    <View style={styles.header}>
                        ...
                        <View style={styles.dateContainer}>
                            <TouchableOpacity
                                ...
                                onPress={() => setCurrentDate(prev => moment(prev).subtract(1, "day"))}
                            >
                            ...
                            <TouchableOpacity
                                style={styles.arrowButton}
                                onPress={() => setCurrentDate(prev => moment(prev).add(1, "day"))}
                            >
                                <Text style={styles.arrowIcon}>{'>'}</Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    {/* Seção Evolução da Pele (Fotos) */}
                    <View style={styles.pictureSection}>
                        <Text style={styles.pictureSectionTitle}>Evolução da Pele(Fotos)</Text>
                        <Picture date={currentDate.format("YYYY-MM-DD")} />
                    </View>
                </ScrollView>
            </LinearGradient>

            {/* Botão animado de salvar (fora do Scroll) */}
