...
function HomeScreen({ navigation }) {
    return ( <
        ...
        /> { / * Adicione um botão para voltar para HomePageNoite se necessário * / } <
        Button title = "Voltar para Home Noturna"
        onPress = {
