...
const DicasNoite = () => {
  return (
    <SafeAreaView style={styles.safeArea}>
      <ImageBackground
        source={require('../../../assets/images/StarryBackground.png')} // Caminho para a sua imagem de fundo
      ...
      >
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.cardContainer}>
            ...
            <TouchableOpacity style={styles.card}>
              <Text style={styles.cardText}>Cuidados especiais da pele negra</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.cardContainer}>
            ...
            <View style={styles.cardContainer}>
                ...
                <TouchableOpacity 
                onPress={() => navigation.navigate('DermatiteDetalhePage')}
                activeOpacity={0.7}>
            </TouchableOpacity>
            </View>
          </View>
